        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="md:w-1/2 space-y-6 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-3 sm:gap-4 pt-4">
              <button className="w-full sm:w-auto bg-[var(--primary-blue)] text-white px-6 py-3 sm:px-4 sm:py-2 rounded-xl sm:rounded-lg flex justify-center items-center gap-3 hover:bg-blue-700 transition-all hover:scale-105 shadow-xl hover:shadow-blue-500/25">
                ...
                <div className="text-left">
                  <div className="text-[11px] sm:text-[10px] text-blue-100 leading-tight">GET IT ON</div>
