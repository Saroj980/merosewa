  ...
  return (
    <footer className="bg-white pt-10 md:pt-20 pb-0 border-t border-slate-200 overflow-hidden relative">
      <div className="container mx-auto px-8 md:px-12 max-w-[1400px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 gap-x-8 lg:gap-x-12 mb-16">
          ...
          <div className="md:col-span-12 lg:col-span-4 flex flex-col gap-6">
            <div className="flex flex-col items-start gap-4">
              <Image 
                ...
                width={200} 
                height={60} 
                className="w-[180px] md:w-[220px] h-auto object-contain object-left shrink-0"
              />
            ...
            <div className="flex justify-start gap-3 mt-2">
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=100092199352894" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-blue-50 text-[var(--primary-blue)] flex items-center justify-center hover:bg-[var(--primary-blue)] hover:text-white transition-colors cursor-pointer">
              ...
              {/* Instagram */}
              <div className="w-9 h-9 rounded-full bg-blue-50 text-[var(--primary-blue)] flex items-center justify-center hover:bg-[var(--primary-blue)] hover:text-white transition-colors cursor-pointer">
          ...
          <div className="md:col-span-3 lg:col-span-2">
            <h4 className="text-slate-900 font-extrabold mb-5 text-[13px] tracking-wider uppercase">Services</h4>
            <ul className="space-y-3.5 text-[14px] font-medium text-slate-500">
              <li><Link href="/services/electrician" className="hover:text-[var(--primary-blue)] transition-colors">Electrician</Link></li>
              <li><Link href="/services/plumbing" className="hover:text-[var(--primary-blue)] transition-colors">Plumbing</Link></li>
              <li><Link href="/services/ac-repair" className="hover:text-[var(--primary-blue)] transition-colors">AC Repair</Link></li>
              <li><Link href="/services/cctv" className="hover:text-[var(--primary-blue)] transition-colors">CCTV</Link></li>
              <li><Link href="/services/cleaning" className="hover:text-[var(--primary-blue)] transition-colors">Cleaning</Link></li>
              <li><Link href="/services" className="hover:text-[var(--primary-blue)] transition-colors">All Services</Link></li>
            </ul>
          </div>
          
          <div className="md:col-span-3 lg:col-span-2">
            <h4 className="text-slate-900 font-extrabold mb-5 text-[13px] tracking-wider uppercase">Company</h4>
            <ul className="space-y-3.5 text-[14px] font-medium text-slate-500">
              <li><Link href="/about" className="hover:text-[var(--primary-blue)] transition-colors">About Us</Link></li>
              <li><Link href="/blog" className="hover:text-[var(--primary-blue)] transition-colors">Blog & News</Link></li>
              <li><Link href="/contact" className="hover:text-[var(--primary-blue)] transition-colors">Contact Us</Link></li>
            </ul>
          </div>
          
          <div className="md:col-span-3 lg:col-span-2">
            <h4 className="text-slate-900 font-extrabold mb-5 text-[13px] tracking-wider uppercase">Quick Links</h4>
            <ul className="space-y-3.5 text-[14px] font-medium text-slate-500">
              <li><Link href="/book" className="text-[#0057D9] font-bold hover:text-blue-700 transition-colors">Book a Service</Link></li>
              <li><Link href="/provider" className="hover:text-[var(--primary-blue)] transition-colors">Become a Provider</Link></li>
            </ul>
          </div>

          <div className="md:col-span-3 lg:col-span-2">
            <h4 className="text-slate-900 font-extrabold mb-5 text-[13px] tracking-wider uppercase">Support</h4>
            <div className="space-y-4 text-[14px] font-medium text-slate-600">
              <div className="flex items-start gap-3">
                ...
                <span>01-5970234</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-4 h-4 mt-0.5 shrink-0 text-green-500" viewBox="0 0 24 24" fill="currentColor"><path d="M12.01 2C6.48 2 2 6.48 2 12c0 1.74.45 3.38 1.25 4.82L2 22l5.35-1.21A9.953 9.953 0 0012.01 22c5.53 0 10.01-4.48 10.01-10s-4.48-10-10.01-10zm0 18.25c-1.46 0-2.88-.38-4.13-1.08l-2.95.67.68-2.88c-.8-1.29-1.22-2.79-1.22-4.34 0-4.63 3.77-8.41 8.41-8.41s8.41 3.78 8.41 8.41-3.77 8.41-8.41 8.41zm4.41-6.13c-.24-.12-1.43-.71-1.65-.79-.22-.08-.38-.12-.55.12-.16.24-.62.79-.76.95-.14.16-.28.18-.52.06-.24-.12-1.02-.38-1.95-1.2-.72-.64-1.2-1.42-1.34-1.66-.14-.24-.01-.37.11-.49.11-.11.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.55-1.33-.76-1.82-.2-.48-.4-.41-.55-.42-.14-.01-.3-.01-.46-.01-.16 0-.42.06-.64.3s-.84.82-.84 2.01.86 2.33.98 2.49c.12.16 1.7 2.6 4.12 3.64.58.25 1.03.4 1.38.51.58.18 1.11.16 1.53.1.47-.07 1.43-.58 1.63-1.15.2-.56.2-.104.14-.114-.06-.02-.22-.04-.46-.16z"/></svg> 
                <span>9800000000</span>
              </div>
              <div className="flex items-start gap-3">
                <Mail className="w-4 h-4 mt-0.5 shrink-0 text-slate-400" /> 
                <span>info@merosewa.com</span>
              </div>
              <div className="flex items-start gap-3">
                <MapPin className="w-4 h-4 mt-0.5 shrink-0 text-slate-400" /> 
                <span className="leading-snug">Dhangadhi, Kailali,<br/>Nepal</span>
              </div>
            </div>
          </div>
        </div>
